...
export default function JobDetail() {
  ...
  const [form, setForm] = useState<FormState | null>(() => (job ? jobToForm(job) : null));
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setForm((prev) =>
                        prev ? { ...prev, prefecture_id: e.target.value, city_id: '' } : prev,
                      )
                    }
                    className={selectCls()}
                  >
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    <select
                      value={form.city_id}
                      onChange={(e) =>
                        setForm((prev) => (prev ? { ...prev, city_id: e.target.value } : prev))
                      }
                      className={selectCls()}
