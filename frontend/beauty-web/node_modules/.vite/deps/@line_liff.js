...
var g$9 = typeof globalThis !== "undefined" && globalThis || typeof self !== "undefined" && self || typeof global !== "undefined" && global || {};
var support = {
	searchParams: "URLSearchParams" in g$9,
	iterable: "Symbol" in g$9 && "iterator" in Symbol,
	blob: "FileReader" in g$9 && "Blob" in g$9 && (function() {
		try {
			new Blob();
			return true;
		} catch (e) {
	...
	formData: "FormData" in g$9,
	arrayBuffer: "ArrayBuffer" in g$9
};
...
function Request(input, options) {
	...
	this.signal = options.signal || this.signal || function() {
		if ("AbortController" in g$9) return new AbortController().signal;
	}();
	this.referrer = null;
...
var DOMException = g$9.DOMException;
try {
	new DOMException();
} catch (err) {
...
function fetch$1(input, init) {
	return new Promise(function(resolve, reject) {
		...
		function fixUrl(url) {
			try {
				return url === "" && g$9.location.href ? g$9.location.href : url;
			} catch (e) {
				return url;
			}
		}
		...
		if (init && typeof init.headers === "object" && !(init.headers instanceof Headers || g$9.Headers && init.headers instanceof g$9.Headers)) {
			var names = [];
...
var i$5 = new (function() {
	function r(o) {
		void 0 === o && (o = n$4.INFO), this.logLevel = o, this._debug = console.debug, this._info = console.info, this._warn = console.warn, this._error = console.error;
	}
	return r.prototype.debug = function() {
		for (var r = [], i = 0; i < arguments.length; i++) r[i] = arguments[i];
		this.logLevel <= n$4.DEBUG && (r.unshift("[DEBUG]"), this._debug.apply(this, __spreadArray([], __read(r), !1)));
	}, r.prototype.info = function() {
		for (var r = [], i = 0; i < arguments.length; i++) r[i] = arguments[i];
		this.logLevel <= n$4.INFO && (r.unshift("[INFO]"), this._info.apply(this, __spreadArray([], __read(r), !1)));
	}, r.prototype.warn = function() {
		for (var r = [], i = 0; i < arguments.length; i++) r[i] = arguments[i];
		this.logLevel <= n$4.WARN && (r.unshift("[WARN]"), this._warn.apply(this, __spreadArray([], __read(r), !1)));
	}, r.prototype.error = function() {
		for (var r = [], i = 0; i < arguments.length; i++) r[i] = arguments[i];
		this.logLevel <= n$4.ERROR && (r.unshift("[ERROR]"), this._error.apply(this, __spreadArray([], __read(r), !1)));
	}, r;
}())(3);
//#endregion
//#region node_modules/@liff/use/lib/index.es.js
var i$4 = function(t, e) {
	this._driver = t, this.liff = e, this.hooks = this._driver.hooks, this.internalHooks = this._driver.internalHooks;
};
var r$7 = function(t, e) {
	this._driver = t, this.liff = e, this.hooks = this._driver.hooks;
};
var s$10 = function() {
	function t(t, e) {
		this.pluginCtx = new r$7(t, e), this.moduleCtx = new i$4(t, e);
	}
...
var c$10 = function(t) {
	...
	return __extends(e, t), e.prototype.install = function() {
		...
		return function(i, r) {
			if (!i || "function" != typeof i.install || "string" != typeof i.name) return i$5.warn("To install the plugin, you need to define the `name` property and the `install` method."), this;
			var s = l$13(i) ? i.name : "".concat(n).concat(i.name);
			if (t.hasModule(s)) return this;
			var u = l$13(i) ? i.install.call(i, e.moduleContext, r) : i.install.call(i, e.pluginContext, r);
			return this["".concat(s)] ? (i$5.warn("There is a duplicate plugin name. `".concat(s, "` plugin namespace will be override.")), this["".concat(s)] = u) : void 0 !== u && (this["".concat(s)] = u), t.addModule(s, i), this;
		};
	}, e;
}(a$7);
//#endregion
...
var e$9;
var n$3 = new Promise(function(n) {
	e$9 = n;
});
//#endregion
//#region node_modules/@liff/consts/lib/index.es.js
var e$8 = "UNKNOWN";
var t = "UNAUTHORIZED";
var E$6 = "INVALID_ARGUMENT";
var I$5 = "INIT_FAILED";
var i$3 = "FORBIDDEN";
var T$4 = "INVALID_CONFIG";
var _$4 = "RATE_LIMIT_EXCEEDED";
var n$2 = "INVALID_ID_TOKEN";
var N$3 = "UNSPECIFIED";
var l$12 = "CREATE_SUBWINDOW_FAILED";
var o$4 = "EXCEPTION_IN_SUBWINDOW";
var D$4 = "liffEvent";
var s$9 = "LIFF_STORE";
var a$6 = "https://liff.".concat("line.me", "/");
var c$9 = "https://miniapp.".concat("line.me", "/");
var r$6 = {
...
var U$5 = "liff.subwindow";
var d$10 = "healthCheck";
var k$3 = [
	"profile",
	"chat_message.write",
	"openid",
...
var d$9 = {
	...
	decodeUnicode: function(n) {
		var r = s$8(n).split("").map(function(n) {
...
function l$11(r) {
	...
	if (4 !== t.length) return i$5.warn("convertArgbToRgba: Received invalid ARGB color"), "";
	var e = function(n) {
		var r = v$9(n);
		return Math.round(r / 255 * 100) / 100;
	}(t[0]), o = v$9(t[1]), i = v$9(t[2]), a = v$9(t[3]);
...
function h$9(r) {
	var t = r.replace("#", "").match(/.{2}/g) || [];
	if (3 !== t.length) return i$5.warn("convertArgbToRgba: Received invalid hex color"), "";
	var e = v$9(t[0]), o = v$9(t[1]), i = v$9(t[2]);
...
var m$10 = {
	...
	set: function(r, t, e) {
		...
		i$5.debug("set cookie", o), document.cookie = o;
	},
	remove: function(n, r) {
...
function b$7(n, r, t) {
	return null != t && t.cause && console.error("This is the cause of LiffError described below.", t.cause), new y$8(n, r || "", t || {});
}
function R$4(n) {
	var r = n.match(/([^-]+)-[^-]+/);
	return r && r[1];
...
var x$4 = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz";
function C$5() {
	return window.crypto.getRandomValues(/* @__PURE__ */ new Uint32Array(1))[0] / 4294967296;
}
function E$5(n) {
	for (var r = "", t = 0; t < n; t++) r += x$4[Math.floor(62 * C$5())];
	return r;
}
function j$2(n) {
	var r = new URL(n);
	return r.hash = r.hash.slice(1).split("&").filter(function(n) {
		return !A$3.some(function(r) {
...
function O$4(n) {
	var r = new URL(n);
	return r.toString().replace(new RegExp(String.raw(T$3 || (T$3 = __makeTemplateObject(["^", ""], ["^", ""])), r.origin)), "");
}
function S$5(n) {
	var r = new URL(n);
...
function D$3(n, r, t) {
	return __awaiter(this, void 0, void 0, function() {
		...
		return __generator(this, function(i) {
			switch (i.label) {
				case 0: o = new Promise(function(n, o) {
					e = setTimeout(function() {
						t?.abort(), o(new Error("Operation timed out after ".concat(r, "ms")));
					}, r);
				}), i.label = 1;
				...
				case 3: return void 0 !== e && clearTimeout(e), [7];
				case 4: return [2];
			}
		});
	});
...
var c$8 = null;
function u$10() {
	return null === c$8 && (c$8 = _$3() || V$3() && /[#|&]access_token=/.test(location.hash) || "1" === sessionStorage.getItem("".concat("LIFF_STORE", ":").concat("isInClient")), sessionStorage.setItem("".concat("LIFF_STORE", ":").concat("isInClient"), c$8 ? "1" : "0")), !!c$8;
}
(function(n) {
	function o() {
...
function a$5(n, t) {
	if (!t) throw b$7(T$4, "liffId is necessary for liff.init()");
	var o = (u$10() ? sessionStorage : localStorage).getItem("".concat(s$9, ":").concat(t, ":").concat(n));
	try {
...
function p$9(n) {
	return a$5(n, c$7().liffId);
}
function s$7(n, t) {
	var o = c$7().liffId;
	if (!o) throw b$7(T$4, "liffId is necessary for liff.init()");
	(u$10() ? sessionStorage : localStorage).setItem("".concat(s$9, ":").concat(o, ":").concat(n), JSON.stringify(t));
}
function E$4() {
	return p$9(r$6.CONTEXT);
}
function I$3(n) {
	s$7(r$6.CONTEXT, n);
}
...
function O$3() {
	return Boolean(p$9(r$6.IS_SUBSEQUENT_LIFF_APP));
}
function P$1(n) {
	s$7(r$6.IS_SUBSEQUENT_LIFF_APP, n);
}
function b$6() {
	return p$9(r$6.APP_DATA);
}
function N$2(n) {
	s$7(r$6.APP_DATA, n);
}
function h$8() {
	return p$9(r$6.MST_VERIFIER);
}
function A$1(n) {
	s$7(r$6.MST_VERIFIER, n);
}
function v$8() {
	return p$9(r$6.MSIT);
}
...
function M() {
	return p$9(r$6.MST_CHALLENGE);
}
function R$3(n) {
	s$7(r$6.MST_CHALLENGE, n);
}
function j$1() {
	return p$9(r$6.CLIENT_ID);
}
function F$3(n) {
	s$7(r$6.CLIENT_ID, n);
}
function K() {
	return p$9(r$6.RAW_CONTEXT);
}
function w$7() {
	return p$9(r$6.FEATURE_TOKEN);
}
function U$3(n) {
	s$7(r$6.FEATURE_TOKEN, n);
}
function X$1() {
	return p$9(r$6.ID_TOKEN);
}
function G$1(n) {
	s$7(r$6.ID_TOKEN, n);
}
...
function x$3() {
	return p$9(r$6.ACCESS_TOKEN);
}
function B$1(n) {
	s$7(r$6.ACCESS_TOKEN, n);
}
(function(t) {
	function r() {
		return null !== t && t.apply(this, arguments) || this;
...
function H$2(n) {
	var t = c$7().liffId;
	if (!t) throw b$7(T$4, "liffId is necessary for liff.init()");
	(u$10() ? sessionStorage : localStorage).removeItem("".concat(s$9, ":").concat(t, ":").concat(n));
}
function J() {
	return p$9(r$6.LOGIN_TMP);
}
function Q$1(n) {
	s$7(r$6.LOGIN_TMP, n);
}
...
function q$2(n) {
	var t = c$7();
	m$10.set("".concat(s$9, ":").concat(r$6.EXPIRES, ":").concat(t.liffId), n.getTime(), {
...
function z$2() {
	var n = c$7();
	return m$10.get("".concat(s$9, ":").concat(r$6.EXPIRES, ":").concat(n.liffId));
}
function Y$1() {
	var n = c$7();
	m$10.remove("".concat(s$9, ":").concat(r$6.EXPIRES, ":").concat(n.liffId), { path: "/" });
}
function Z$1() {
	return p$9(r$6.DECODED_ID_TOKEN);
}
function $$1(n) {
	s$7(r$6.DECODED_ID_TOKEN, n);
}
(function(t) {
	function r() {
		return null !== t && t.apply(this, arguments) || this;
...
function tn() {
	Object.keys(r$6).forEach(function(n) {
		H$2(r$6[n]);
	}), Y$1();
}
//#endregion
...
var l$9 = function() {
	...
	return Object.defineProperty(t, "IN_SUB_WINDOW_KEY", {
		...
		var n = this.storage.getItem("".concat(s$9, ":").concat(this.getLiffId(), ":").concat(t.IN_SUB_WINDOW_KEY));
		...
		this.storage.setItem("".concat(s$9, ":").concat(this.getLiffId(), ":").concat(t.IN_SUB_WINDOW_KEY), String(n));
...
var m$8 = new (function(n) {
	function i() {
		var t = n.call(this) || this;
		return z$3() ? t.impl = { invoke: function() {
			return !1;
		} } : u$10() ? t.impl = new a$4() : t.impl = new l$9(window.sessionStorage), t;
	}
...
function h$7(e, r, i) {
	...
	var o = n.minVer, c = n.unsupportedFromVer, s = !o || function(e, r) {
		var i = r$4();
		return !!i && !(r && p$10(i, r) > 0) && p$10(i, e) >= 0;
	}(o, c), d = u$10();
	return d && !s ? {
		available: !1,
		error: {
...
var C$3 = {
	...
	getAdvertisingId: function() {
		return h$7("getAdvertisingId");
	},
	bluetoothLeFunction: function() {
		return h$7("bluetoothLeFunction");
	},
	...
	multipleLiffTransition: function() {
		var e = g$6("multipleLiffTransition");
		return e && e.permission ? u$10() ? { available: !0 } : {
			available: !1,
			error: {
				code: i$3,
	...
	scanCodeV2: function() {
		...
		var e = S$3();
		return e.available ? h$7("scanCodeV2", !0) : e;
	},
	...
	skipChannelVerificationScreen: function() {
		...
		} : h$7("skipChannelVerificationScreen") : {
			available: !1,
			error: {
				code: i$3,
	...
	createShortcutOnHomeScreen: function() {
		...
		} : h$7("addToHomeV2", !0, "createShortcutOnHomeScreen");
	},
	internalCreateShortcutOnHomeScreen: function() {
		...
		var r = h$7("addToHomeV2", !0, "internalCreateShortcutOnHomeScreen");
		return r.available ? h$7("addToHomeLineScheme", !0, "internalCreateShortcutOnHomeScreen") : r;
	},
	iap: function() {
		return u$10() ? e$7() ? d$7() ? {
			available: !1,
	...
	requestFriendship: function() {
		...
		var e = E$4();
		return (null == e ? void 0 : e.hasLinkedBot) ? S$3() : {
			available: !1,
			error: {
				code: i$3,
	...
	activityGetCallState: function() {
		return h$7("activityGetCallState", !1, "liff.activity.getCallState");
	},
	activityGetRecordingState: function() {
		return h$7("activityGetRecordingState", !1, "liff.activity.getRecordingState");
	}
};
var y$6 = function(e) {
	return function() {
		var r = e();
		if (!r.available) throw b$7(r.error.code, r.error.message);
	};
};
var k = {
	scanCode: y$6(C$3.scanCode),
	getAdvertisingId: y$6(C$3.getAdvertisingId),
	bluetoothLeFunction: y$6(C$3.bluetoothLeFunction),
	shareTargetPicker: y$6(C$3.shareTargetPicker),
	multipleLiffTransition: y$6(C$3.multipleLiffTransition),
	subwindowOpen: y$6(C$3.subwindowOpen),
	scanCodeV2: y$6(C$3.scanCodeV2),
	addToHomeScreen: y$6(C$3.addToHomeScreen),
	skipChannelVerificationScreen: y$6(C$3.skipChannelVerificationScreen),
	createShortcutOnHomeScreen: y$6(C$3.createShortcutOnHomeScreen),
	internalCreateShortcutOnHomeScreen: y$6(C$3.internalCreateShortcutOnHomeScreen),
	iap: y$6(C$3.iap),
	requestFriendship: y$6(C$3.requestFriendship),
	activityGetCallState: y$6(C$3.activityGetCallState),
	activityGetRecordingState: y$6(C$3.activityGetRecordingState)
};
function T$1(e) {
	if (!function(e) {
		return w$6.some(function(r) {
			return r === e;
		});
	}(e)) throw b$7(E$6, "Unexpected API name.");
	var r = C$3[e];
...
var o$2 = function() {
	function n(o) {
		p$10(r$5(), n.SDK_VERSION_SUPPORTING_NEW) >= 0 ? this.impl = new e$3() : this.impl = new r$2(o);
	}
...
var u$9 = function(t, e) {
	return u$9 = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(t, e) {
		t.__proto__ = e;
	} || function(t, e) {
		for (var n in e) Object.prototype.hasOwnProperty.call(e, n) && (t[n] = e[n]);
	}, u$9(t, e);
};
function s$6(t, e, n, r) {
...
var p$7 = function(t) {
	...
	return function(t, e) {
		...
		u$9(t, e), t.prototype = null === e ? Object.create(e) : (n.prototype = e.prototype, new n());
...
function y$5() {
	var t;
	return "ios" === e$4() ? (t = r$4()) && p$10(t, "9.19.0") < 0 ? "https://static.line-scdn.net/liff/edge/2/ios-918-extensions_2_22_0.js" : "https://static.line-scdn.net/liff/edge/2/ios-extensions_2_22_0.js" : "https://static.line-scdn.net/liff/edge/2/non-ios-extensions_2_22_0.js";
}
function d$6() {
	return D$3(new Promise(function(n, r) {
		var o = document.createElement("script");
		o.onload = function() {
			var o = window.liffClientExtension;
			o ? n(o) : r(b$7(I$5, "Unable to load client features. (Extension is empty)"));
		}, o.onerror = function(n) {
			r(b$7(I$5, "Unable to load client features.", { cause: n }));
		}, o.src = y$5(), o.type = "text/javascript", document.body.appendChild(o);
	}), 1e4);
}
function b$5() {
	return l$8() ? function() {
		return s$6(this, void 0, void 0, function() {
			return a$3(this, function(t) {
				switch (t.label) {
					case 0: return [3, 2];
...
var g$5 = /([\x90\x9D\x81\x8D\x8F<"{|}>\\^`“›„•‚ŽŠ…’—ž–‘”‡™‰ŒšŸ‹œ†¥¿©áÄýÍÎðô]|\n|.*#.*#|%(?![0-9A-Fa-f]{2})[^%]{0,2})/;
var v$7 = function(n) {
	if (g$5.test(n)) throw b$7(E$6, "invalid URL.");
...
var U$2 = function(e, i) {
	var a = function(r, e) {
		...
		try {
			for (var s = __values(o.entries()), u = s.next(); !u.done; u = s.next()) {
				...
				c.push("".concat(x$2(l), "=").concat(x$2(h)));
			}
		} catch (m) {
			e = { error: m };
		} finally {
	...
	}(w$5(e).join("&")), w$5(i)).join("&");
	return "" !== a ? "?".concat(a) : "";
};
var y$4 = function(n, t) {
	return 0 === t.indexOf(n) && (n.endsWith("/") && (n = n.substring(0, n.length - 1)), void 0 === t[n.length] || "/" === t[n.length]);
};
var b$4 = function(n, t) {
	var r = v$7(n), e = new URL(t);
	if (r.username !== e.username || r.password !== e.password) throw b$7(E$6, "invalid URL.");
	if (e.origin !== r.origin || !y$4(e.pathname, r.pathname)) throw b$7(E$6, "invalid URL.");
};
var L$2 = new (function(r) {
	function o() {
		var e = r.apply(this, __spreadArray([], __read(arguments), !1)) || this;
		return e.extraParams = "", e.getAndValidateContext = function() {
			var n = E$4();
			if (!n) throw b$7(I$5, "Could not get Context from server.");
			if (!n.endpointUrl) throw b$7(I$5, "Could not get endpointUrl from server.");
			if (!n.permanentLinkPattern) throw b$7(I$5, "Could not get permanentLinkPattern from server.");
			return n;
			...
			if (s.origin !== o || !y$4(s.pathname, r)) throw b$7(T$4, "Current page is not under entrypoint.");
			var l = r.substring(s.pathname.length);
			l.length > 0 && "/" !== l[0] && (l = "/" + l);
			var p = new RegExp("^".concat(A$3.join("|"))), d = a.substring(1).split("&").filter(function(n) {
			...
			return "".concat(a$6).concat(c$7().liffId).concat(P);
		}, e.createUrlBy = function(n) {
			return __awaiter(e, void 0, void 0, function() {
				var t, r, e, i, o, u;
				return __generator(this, function(a) {
					if (!(t = c$7().liffId)) throw b$7(I$5, "Should run after liff init.");
					return r = this.getAndValidateContext(), b$4(n, r.endpointUrl), e = v$7(n), i = new URL(r.endpointUrl), o = r.miniDomainAllowed ? c$9 : a$6, u = r.miniDomainAllowed && r.miniAppId ? r.miniAppId : t, [2, o.concat(u, (w = e.pathname, x = i.pathname, y = w.substring(x.length), "/" === y ? "" : (y.length > 0 && "/" !== y[0] && (y = "/" + y), y)), U$2(e.search, i.search), (p = e.hash, d = new RegExp("^".concat(A$3.join("|"))), g = p.substring(1).split("&").filter(function(n) {
	...
	return __awaiter(this, void 0, void 0, function() {
		...
		return __generator(this, function(t) {
			switch (t.label) {
				...
				case 4: return e = String(a.status), r = w$8.has(e) ? e : e$8, [4, a.json().catch(function() {
					throw b$7(r, a.statusText);
				})];
				case 5: throw s = t.sent(), b$7(s.error || s.errorCode || r, s.error_description || s.message);
			}
		});
	});
}
function u$8(e) {
	var t$11 = function(e) {
		if (e) return e;
		var t$10 = x$3();
		if (!t$10) throw b$7(t, "Need access_token for api call, Please login first");
		return {
			"Content-Type": "application/json",
			Accept: "application/json",
			Authorization: "Bearer ".concat(t$10)
		};
	}(e && e.headers);
	return __assign(__assign({}, e), { headers: t$11 });
}
function f$9(e, t) {
	var a;
	try {
...
var m$7 = {
	token: h$6({ pathname: "oauth2/v2.1/token" }),
	certs: h$6({ pathname: "oauth2/v2.1/certs" }),
	"openid-configuration": h$6({
		subdomain: "access",
	...
	profile: h$6({ pathname: "v2/profile" }),
	message: h$6({ pathname: "message/v3/share" }),
	friendship: h$6({ pathname: "friendship/v1/status" }),
	shareTargetPicker: h$6({
		subdomain: "access",
		pathname: "oauth2/v2.1/liff/shareTargetPicker"
	}),
	shareTargetPickerOtt: h$6({ pathname: "liff/v2/apps" }),
	shareTargetPickerResult: h$6({
		subdomain: "access",
		pathname: "oauth2/v2.1/liff/shareTargetPicker/result"
	}),
	apps: h$6({ pathname: "liff/v2/apps" }),
	subWindowGetMSIT: h$6({ pathname: "liff/v2/sub/msit" }),
	subWindowGetMSTByMSIT: h$6({ pathname: "liff/v2/sub/mst" }),
	subWindowSubscribe: h$6({
		subdomain: "liff",
		pathname: "liff/v2/sub/waitResult"
	}),
	subWindowPost: h$6({ pathname: "liff/v2/sub/result" }),
	subWindowGetAppData: h$6({ pathname: "liff/v2/sub/appData" }),
	subWindowGetOrigin: function(e) {
		return h$6({ pathname: "liff/v2/sub/".concat(e, "/origin") });
	},
	accessTokenVerify: h$6({ pathname: "oauth2/v2.1/verify" }),
	unauthorizedPermissions: h$6({
		subdomain: "liff",
	...
	createShortcutOnHomeScreen: h$6({
		subdomain: "liff-shortcut",
		pathname: "api/shortcut"
	}),
	iapVirtualConfirm: h$6({ pathname: "iap/v1/product/virtualConfirm" }),
	oaAddFriendRateLimit: h$6({
		subdomain: "liff",
...
function d$5(e) {
	return f$9("".concat(l$7("accessTokenVerify"), "?access_token=").concat(encodeURIComponent(e)), { headers: {
		"Content-Type": "application/json",
		Accept: "application/json"
	} });
}
...
var d$4 = "liff.subwindow.identifier";
var u$7 = "liff.subwindow.cryptokey";
var l$6 = __assign(__assign({}, L$5), {
	GET_DATA: "getData",
	SET_DATA: "setData",
	NOT_FOUND: "notFound",
	TEARDOWN: "teardown"
		...
		return __generator(this, function(n) {
			switch (n.label) {
				case 0: return n.trys.push([
					...
					alg: "A128GCM",
					ext: !0
				}, { name: m$6 }, !1, ["encrypt", "decrypt"])];
				case 1: return [2, n.sent()];
				case 2: throw t = n.sent(), b$7(e$8, t);
				case 3: return [2];
			}
		});
	});
};
var w$4 = function(e, i, r) {
	return __awaiter(void 0, void 0, void 0, function() {
		var t, a, o, d;
		return __generator(this, function(n) {
			switch (n.label) {
				case 0: return n.trys.push([
					...
					,
					4
				]), t = new TextEncoder().encode(e), [4, y$3(i)];
				...
				case 3: throw d = n.sent(), b$7(e$8, d);
				case 4: return [2];
			}
		});
	});
};
var g$4 = function(e, i, r) {
	return __awaiter(void 0, void 0, void 0, function() {
		var t, a, o, d, u, l, f;
		return __generator(this, function(n) {
			switch (n.label) {
				...
				case 3: throw f = n.sent(), b$7(e$8, f);
				case 4: return [2];
			}
		});
	});
};
var b$3 = function(e, t) {
	return E$3(e) === E$3(t);
};
var E$3 = function(e) {
...
var A = function(e) {
	return Object.keys(L$5).map(function(e) {
		return L$5[e];
	}).includes(e) ? f$8.BROADCAST : f$8.COMMAND;
};
function T() {
...
var D$1 = function(o) {
	...
	this.identification = {
		...
		return __awaiter(v, void 0, void 0, function() {
			...
			return __generator(this, function(f) {
				switch (f.label) {
					...
					}, r = this, l = { identifier: this.windowType === h$5.MAIN ? E$5(12) : e.get("liff.subwindow.identifier") || i("liff.subwindow.identifier") || "" }, this.windowType !== h$5.MAIN ? [3, 2] : [4, __awaiter(void 0, void 0, void 0, function() {
						var e, t, i;
						return __generator(this, function(n) {
							switch (n.label) {
								case 0: return n.trys.push([
								...
								case 2:
									if (!(t = n.sent()) || !t.k) throw b$7(e$8, "failed to generate key");
									return [2, t.k];
								case 3: throw i = n.sent(), b$7(e$8, i);
								case 4: return [2];
							}
						});
					})];
			...
			return __generator(this, function(n) {
				switch (n.label) {
					...
					case 1:
						...
						if (t = /^[a-zA-Z0-9]+$/gm, !e.match(t)) throw b$7(e$8, "Invalid identifier");
		...
		return __awaiter(v, void 0, void 0, function() {
			...
			return __generator(this, function(n) {
				switch (n.label) {
					case 0: return this.isReady() ? [4, this.send({ eventName: l$6.TEARDOWN })] : [3, 2];
		...
		var n = function(i) {
			i.replyTarget && b$3(i.replyTarget, e) && (t(i), v.listeners.delete(n));
		};
		v.listeners.set(n, n);
		...
		return __awaiter(v, void 0, void 0, function() {
			...
			return __generator(this, function(n) {
				switch (n.label) {
					case 0:
						if (!this.isReady()) throw b$7("message bus is not ready to send message");
						return i = {
							action: A(e.eventName),
							identifier: this.identification.identifier || "",
							timestamp: (/* @__PURE__ */ new Date()).getTime()
						}, [4, this.getEncryptedContext(e)];
					case 1: return i.context = n.sent(), t = i, null === (a = null === (r = this.messageHandlerInstance) || void 0 === r ? void 0 : r.contentWindow) || void 0 === a || a.postMessage({ messageBusEvent: t }, "*"), this.sentMessages.push(E$3(t)), [4, new Promise(function(e) {
		...
		return __awaiter(v, void 0, void 0, function() {
			...
			return __generator(this, function(n) {
				switch (n.label) {
					case 0:
						if (!this.isReady()) throw b$7("message bus is not ready to send message");
						if (!e.identifier || !e.timestamp) throw b$7(e$8, "target message is not valid");
						return r = { action: f$8.BROADCAST }, [4, this.getEncryptedContext(i)];
					...
					}, t = r, null === (o = null === (a = this.messageHandlerInstance) || void 0 === a ? void 0 : a.contentWindow) || void 0 === o || o.postMessage({ messageBusEvent: t }, "*"), this.sentMessages.push(E$3(t)), [2];
				}
			});
		});
	}, this.setData = function(e, t) {
		void 0 === e && (e = "appData"), v.send({
			eventName: l$6.SET_DATA,
			key: e,
			data: t
		});
		...
		return __awaiter(v, void 0, void 0, function() {
			var r, s = this;
			return __generator(this, function(a) {
				return r = i.data.messageBusEvent, "https://liff-subwindow.line.me" !== i.origin ? [2] : r ? (this.sentMessages.includes(E$3(r)) || r.identifier !== this.identification.identifier || r.action !== f$8.BROADCAST && !r.replyTarget || this.listeners.forEach(function(i) {
		...
		return __awaiter(v, void 0, void 0, function() {
			...
			return __generator(this, function(n) {
				switch (n.label) {
					...
					}, e.data ? [4, w$4(i, r, JSON.stringify(e.data))] : [3, 2];
		...
		return __awaiter(v, void 0, void 0, function() {
			...
			return __generator(this, function(n) {
				switch (n.label) {
					case 0: return t = this.identification, r = t.identifier, s = t.cryptoKey, (a = JSON.parse(i)).data && "string" == typeof a.data ? (u = (d = JSON).parse, [4, g$4(r, s, a.data)]) : [3, 2];
...
function l$5(e) {
	return new CustomEvent(D$4, { detail: e });
}
(function() {
...
var c$5 = !1;
function s$5(e, i) {
	c$5 || (c$5 = !0, window.addEventListener("liffEvent", function(t) {
		t && t.detail && t.detail.type && f$7[t.detail.type] && f$7[t.detail.type].forEach(function(e) {
			return e(t);
		});
	})), f$7[e] ? f$7[e].push(i) : f$7[e] = [i];
}
function u$6(t, e) {
	var i = f$7[t];
...
function v$6(t) {
	...
	try {
		...
		throw b$7(E$6, r.message);
	}
	var a = l$5(i);
	i$5.debug("[client dispatchEvent to js]", {
		type: a.type,
		detail: a.detail
...
function p$5(t, a, d) {
	...
	var l = w$7();
	if (!l) throw b$7(i$3, "Invalid featureToken for client features");
	if (!window._liff || !window._liff.postMessage) throw b$7(E$6, "postMessage is not available from client");
	i$5.debug("[js postMessage to client]", t, d, a), window._liff.postMessage(t, l, d, JSON.stringify(a));
}
function w$3(t, e, l) {
	return void 0 === e && (e = {}), void 0 === l && (l = { once: !0 }), w$7() ? (l = __assign({
		callbackId: E$5(12),
		once: !0
		...
		var a = function(e) {
			if (e && e.detail) {
				...
				(r || d) && (l.once && u$6(t, a), i$5.debug("[callback detail]", e.detail), e.detail.error ? n(e.detail.error) : e.detail.data ? i(e.detail.data) : n(e.detail));
			}
			n();
		};
		s$5(t, a), p$5(t, e, l.callbackId);
	})) : Promise.reject(b$7(i$3, "Invalid featureToken for client features"));
}
//#endregion
//#region node_modules/@liff/close-window/lib/index.es.js
function r$1() {
	var o = r$4();
	null !== o && ("ios" === e$4() && p$10(o, "9.19") >= 0 || "android" === e$4() && p$10(o, "11.6.0") >= 0) ? location.href = "liff://close" : window._liff && window._liff.postMessage ? null !== o && p$10(o, "10.15.0") >= 0 ? "ios" === e$4() ? window._liff.postMessage("closeWindow", "") : window._liff.postMessage("closeWindow", "", "", "") : w$3("closeWindow") : window.close();
}
(function(i) {
	function n() {
...
function G(e) {
	return f$9(l$7("subWindowGetOrigin")(e));
}
var V$1 = {};
function F$1(e, t) {
...
var Z = function() {
	...
	return e.prototype.getItem = function(e) {
		...
		return "".concat(s$9, ":").concat(this.getLiffId());
	}, e.prototype.getLiffId = function() {
		var e = c$7().liffId;
		if (!e) throw b$7(T$4, "liffId is necessary for liff.init()");
		return e;
	}, e;
}();
var $ = new Z(new I$4());
...
function ue() {
	return __awaiter(this, arguments, void 0, function(e) {
		return void 0 === e && (e = h$5.MAIN), __generator(this, function(t) {
			switch (t.label) {
				case 0: return [4, (Y = new D$1(e)).setup()];
...
var ce = new I$4();
var fe = new Z(z$3() ? ce : window.sessionStorage);
		...
		return void 0 === n && (n = {}), __generator(this, function(t) {
			switch (t.label) {
				case 0:
					...
					if (i = JSON.stringify(n), o = c$7().liffId, s = me(), !window.opener || !s || !o) throw b$7(o$4);
					u = !1, t.label = 1;
				case 1: return t.trys.push([
					1,
					3,
				...
				case 3: throw c = t.sent(), i$5.debug(c), b$7(o$4);
				case 4: return f = u ? s : location.origin, [2, new Promise(function(t) {
					window.addEventListener("message", function n(r) {
						(function(e) {
							if (e.data && "string" == typeof e.data.type && [L$5.SUBMIT, L$5.CANCEL].includes(e.data.type)) return !0;
							return !1;
	...
	if (e.origin === n) {
		...
		if (r) {
			...
			switch (o) {
				...
				case L$5.CANCEL:
				case L$5.SUBMIT:
					ne(!0), window.clearInterval(oe()), window.removeEventListener("message", pe), F$1(o, i), null === (t = ie()) || void 0 === t || t.postMessage({ type: o }, se());
					break;
				default: i$5.debug("unexpected message");
			}
		}
	}
}
		...
		return __generator(this, function(t) {
			...
			switch (e = n.context, r = e.eventName, i = e.data, o = ae(), r) {
				...
				case L$5.SUBMIT:
					...
					break;
				case L$5.CLOSE: !1 === te() && (ne(!0), F$1(L$5.CLOSE, {})), be();
			}
			return [2];
		});
	});
...
function we() {
	window.clearInterval(H$1), window.clearInterval(oe()), window.removeEventListener("message", pe);
}
function ge(e) {
...
function ye(i) {
	return __awaiter(this, void 0, void 0, function() {
		...
		return __generator(this, function(t) {
			switch (t.label) {
				case 0: return (e = F$4(i.url)) ? (ge(!0), [4, be()]) : [2, Promise.reject(b$7(E$6, "params.url must be liff url or mini url"))];
				case 1: return t.sent(), re("ios" !== e$4() || J$1() ? window.open("", "liffsubwindow", "width=480, height=640, menubar=no, toolbar=no, scrollbars=yes") : window.open()), o = i.url, s = i.appData, (u = new URL(o)).searchParams.append(U$5, "true"), [4, ue()];
				case 2: return a = t.sent(), u.searchParams.append(d$4, a.identification.identifier), u.searchParams.append(u$7, a.identification.cryptoKey), u.hostname = function(e) {
					var t = __read(e.split(".")), i = t[0], o = t.slice(1);
					return __spreadArray(["".concat(i, "-ext")], __read(o), !1).join(".");
				}(u.hostname), c = u.toString(), [4, G(e)];
				case 3:
					if (f = t.sent(), l = f.origin, b = f.subwindowCommonModule, !(y = ie())) throw b$7(l$12);
				...
				case 7: return y.location.href = c, C = function(e, t) {
					...
					var e = ie();
					e && e.closed && (we(), re(null), !1 === te() && (ne(!0), F$1(L$5.CLOSE, {})));
				}, 100)), [2];
			}
			var C;
		});
		...
		return __generator(this, function(C) {
			switch (C.label) {
				case 0:
					...
					}, m = Date.now(), null === Se && (Se = m), v = m - Se, a >= 10 || v > 6e5) return l(b$7(e$8, "Failed to connect")), [2];
					C.label = 1;
				...
				case 7: return h.status >= 400 && 500 > h.status ? [4, Pe$1(h)] : [3, 9];
				case 8: return g = C.sent(), w = g ? b$7(E$6, g.errorDetail) : b$7(e$8, "Some error happened in the server"), l(w), [3, 17];
				case 9: return 200 !== h.status ? [3, 16] : [4, Pe$1(h)];
				case 10:
					if (!(g = C.sent())) return l(b$7(e$8, "Some error happened in the server")), [2];
					switch (y = g.status, S = g.result, y) {
						case L$5.ERROR: return [3, 11];
						case L$5.CLOSE:
						case L$5.CANCEL:
						case L$5.SUBMIT: return [3, 13];
					}
					return [3, 14];
				case 11: return [4, c()];
				case 12: return C.sent(), [3, 15];
				case 13: return f(y, S), [3, 15];
				case 14: l(b$7(e$8, "Some error happened in the server")), C.label = 15;
				case 15: return [3, 17];
				case 16: l(b$7(e$8, "Some error happened in the server")), C.label = 17;
				case 17: return [2];
			}
		});
	});
...
function Le$1(n) {
	var r = n.appData, i = n.native, o = c$7().liffId, s = M(), u = F$4(n.url);
	if (!o) return Promise.reject(b$7(t, "liffId is invalid"));
	if (!s) return Promise.reject(b$7(t, "mst_challenge is invalid"));
	if (!u) return Promise.reject(b$7(E$6, "params.url must be liff url or mini url"));
	return function(e) {
		var t = e.mainLiffId, n = e.subLiffId, r = e.mstChallenge, i = e.appData, o = e.view;
		return t && r ? f$9(l$7("subWindowGetMSIT"), {
			method: "POST",
			body: JSON.stringify({
				mainLiffId: t,
				subLiffId: n,
		...
		}) : Promise.reject(b$7(E$6, "no proper argument"));
	}({
		mainLiffId: o,
		subLiffId: u,
		mstChallenge: s,
		appData: r,
		view: Ce(Object.assign({}, Oe$1, i))
	}).then(function(e) {
		var t = e.msit;
		return Ie({
			msit: t,
			...
			return __awaiter(this, void 0, void 0, function() {
				...
				return __generator(this, function(t) {
					switch (t.label) {
						...
						case 1: return t.sent(), location.href = "".concat(p$11, "?url=").concat(encodeURIComponent(e), "&").concat(i.toString()), [2];
					}
				});
			});
		}(n, r);
...
function Ee$1(e) {
	return k.subwindowOpen(), u$10() ? Le$1(e) : ye(e);
}
function Ne$1(e) {
	if (!e.mst || !e.status) return Promise.reject(b$7(E$6, "no proper argument"));
	var t = JSON.stringify(e);
	return f$9(l$7("subWindowPost"), {
		method: "POST",
		body: t
	});
}
function Te$1() {
	if (!d$7()) throw b$7(t, "this api can be only called in child window");
}
function je$1(n) {
	return void 0 === n && (n = {}), Te$1(), u$10() ? function() {
		return __awaiter(this, arguments, void 0, function(e) {
			var n, r;
			return void 0 === e && (e = {}), __generator(this, function(t$7) {
				switch (t$7.label) {
					case 0: return (n = D$2()) ? [4, Ne$1({
						mst: n,
						status: L$5.CANCEL,
						result: e
					})] : [2, Promise.reject(b$7(t, "mst is invalid"))];
					case 1: return r = t$7.sent(), ne(!0), [2, r];
				}
			});
		});
	}(n) : function(e) {
		return void 0 === e && (e = {}), ve(L$5.CANCEL, e);
	}(n);
}
function Me$1(n) {
	return void 0 === n && (n = {}), Te$1(), u$10() ? function() {
		return __awaiter(this, arguments, void 0, function(e) {
			var n, r;
			return void 0 === e && (e = {}), __generator(this, function(t$8) {
				switch (t$8.label) {
					case 0: return (n = D$2()) ? [4, Ne$1({
						mst: n,
						status: L$5.SUBMIT,
					...
					case 1: return r = t$8.sent(), ne(!0), [2, r];
				}
			});
		});
	}(n) : function(e) {
		return void 0 === e && (e = {}), ve(L$5.SUBMIT, e);
	}(n);
}
function Be() {
	return Te$1(), u$10() ? function() {
		return __awaiter(this, void 0, void 0, function() {
			var e;
			return __generator(this, function(t$9) {
				switch (t$9.label) {
					case 0: return !1 !== te() ? [3, 2] : (e = D$2()) ? [4, Ne$1({
						mst: e,
						status: L$5.CLOSE,
						result: {}
					})] : [2, Promise.reject(b$7(t, "mst is invalid"))];
					case 1: t$9.sent(), t$9.label = 2;
					case 2: return r$1(), [2];
				}
			});
		});
		...
		return __awaiter(this, void 0, void 0, function() {
			var e;
			return __generator(this, function(t) {
				return (null == (e = ae()) ? void 0 : e.isReady()) ? (e.send({ eventName: L$5.CLOSE }), [2, new Promise(function(e) {
					setTimeout(function() {
						r$1(), e();
					}, 100);
				})]) : (r$1(), [2, Promise.resolve()]);
			});
		});
	}();
}
function De$1() {
	return Te$1(), function() {
		var e, t = b$6();
		try {
			e = t ? JSON.parse(t) : {};
		} catch (n) {
...
function Ae$1(e) {
	...
	return t && n ? f$9(l$7("subWindowGetMSTByMSIT"), {
		method: "POST",
		body: JSON.stringify({
			msit: t,
			mstVerifier: n
...
function Je$1(e) {
	var t = e.mst;
	return t ? f$9(l$7("subWindowGetAppData"), {
		method: "POST",
...
(function(e) {
	...
	return __extends(t, e), Object.defineProperty(t.prototype, "name", {
		...
		return {
			...
			off: q$1.bind(this),
			open: function(t) {
				return Ee$1.call(e, __assign(__assign({}, t), { onBeforeTransition: void 0 }));
			},
			cancel: je$1.bind(this),
			submit: Me$1.bind(this),
			close: Be.bind(this),
			getAppData: De$1.bind(this)
		};
	}, t;
})(a$7);
//#endregion
...
var f$6 = "Invalid \"alg\" value in ID_TOKEN";
var d$3 = "Failed to use Crypto API to verify ID_TOKEN";
var v$5 = "Invalid \"kid\" value in ID_TOKEN";
var h$4 = "Invalid \"iss\" value in ID_TOKEN";
var p$4 = "Invalid \"aud\" value in ID_TOKEN";
var I$2 = "Invalid \"exp\" value in ID_TOKEN";
var m$5 = "Invalid signature in ID_TOKEN";
var w$2 = "Invalid payload in ID_TOKEN";
function y$2(s, c) {
	return __awaiter(this, void 0, void 0, function() {
		...
		return __generator(this, function(t) {
			switch (t.label) {
				case 0:
					if (e = s.split("."), y = __read(e, 3), D = y[0], E = y[1], N = y[2], O = JSON.parse(d$9.decode(D)), K = function(e) {
						var t = e.split(".");
						if (3 !== t.length || t.some(function(e) {
							return 0 === e.length;
						})) return null;
						try {
							return JSON.parse(d$9.decodeUnicode(t[1]));
						} catch (y) {
							return null;
						}
					}(s), !K) throw b$7(n$2, w$2);
					return T = g$8(d$9.decode(N)), _ = g$8("".concat(D, ".").concat(E)), [4, u$5()];
				case 1:
					if (b = t.sent(), !(g = b.keys.find(function(e) {
						return e.kid === O.kid;
					}))) return [3, 6];
					if (delete g.alg, "ES256" !== O.alg) throw b$7(n$2, f$6);
					S = void 0, t.label = 2;
				...
				case 4: throw k = t.sent(), b$7(n$2, "".concat(d$3, ": ").concat(k));
				case 5:
					if (S) {
						if (A = K.iss !== "https://access.".concat("line.me"), C = K.aud !== c, x = 1e3 * K.exp < Date.now(), A) throw b$7(n$2, h$4);
						if (C) throw b$7(n$2, p$4);
						if (x) throw b$7(n$2, I$2);
						return [2, K];
					}
					throw b$7(n$2, m$5);
				case 6: throw b$7(n$2, v$5);
				case 7: return [2];
			}
		});
	});
...
var v$4 = function(i) {
	var o, r = E$5(43), d = A$2((0, import_tiny_sha256.default)(r)).replace(/\+/g, "-").replace(/\//g, "_").replace(/=/g, ""), _ = c$7();
	if (!_ || !_.liffId) throw b$7(T$4, "You need to define `liffId` for liff.login()");
	var v = {
		app_id: _.liffId,
		state: E$5(12),
		response_type: "code",
	...
	i && i.redirectUri && (v.redirect_uri = i.redirectUri), d$7() && !u$10() && ((null === (o = ae()) || void 0 === o ? void 0 : o.isReady()) ? v.redirect_uri = window.location.href : v.disable_auto_login = "true"), Q$1({ codeVerifier: r });
	var w = l$7("authorize") + "?" + L$4.stringify(v);
	i$5.debug("[Redirect] ".concat(w)), window.location.href = w;
};
var w$1 = function(e) {
	function t() {
		var i = e.apply(this, __spreadArray([], __read(arguments), !1)) || this;
		return i.hooks = { before: new s$4() }, i;
	}
	return __extends(t, e), Object.defineProperty(t.prototype, "name", {
		get: function() {
			return "login";
		...
		this.hooks.before.call(i), v$4(i);
	}, t;
}(a$7);
//#endregion
//#region node_modules/@liff/i18n/lib/index.es.js
var u$4;
var c$4 = "undefined" == typeof navigator ? "en" : null !== (u$4 = navigator.language) && void 0 !== u$4 ? u$4 : "en";
var f$5 = null;
var p$3 = !1;
function d$2(n) {
	return __awaiter(this, void 0, void 0, function() {
		...
		return __generator(this, function(e) {
			switch (e.label) {
				case 0: return e.trys.push([
					...
					3,
					4
				]), n = new AbortController(), [4, D$3(f$9("".concat("https://liffsdk.line-scdn.net/xlt/manifest.json"), {
					method: "GET",
					headers: { Accept: "application/json" },
					signal: n.signal
				}), 5e3, n)];
				case 1: return t = e.sent(), r = "".concat(c$4), !t.languages[r] && c$4.includes("-") && (r = c$4.split("-")[0]), t.languages[r] || (r = "en"), i = new AbortController(), [4, D$3(f$9("".concat("https://liffsdk.line-scdn.net/xlt", "/").concat(t.languages[r]), {
					method: "GET",
					headers: { Accept: "application/json" },
					signal: i.signal
				}), 5e3, i)];
				case 2: return f$5 = e.sent(), [3, 4];
				case 3: return p$3 = !0, [7];
				case 4: return [2];
			}
		});
	});
...
function g$3(n) {
	if (null === f$5) {
		if (p$3) return n;
		throw b$7(I$5, "please call xlt after liff.init");
	}
	return f$5[n];
}
var b$2 = new (function(r) {
	function i() {
		return null !== r && r.apply(this, arguments) || this;
	}
	return __extends(i, r), Object.defineProperty(i.prototype, "name", {
		get: function() {
			return "i18n";
		},
		enumerable: !1,
		configurable: !0
	}), i.prototype.install = function(n) {
		return n.internalHooks.init.beforeFinished(this.beforeInitFinished.bind(this)), { setLang: d$2 };
	}, i.prototype.beforeInitFinished = function() {
		return __awaiter(this, void 0, void 0, function() {
			var n;
			return __generator(this, function(t) {
				switch (t.label) {
					...
					case 2: return n = t.sent(), i$5.warn("[LIFF I18n] failed to load XLT data, falling back to raw keys", n), [3, 3];
					case 3: return [2];
				}
			});
		});
...
function Te() {
	var e;
	Pe("color-scheme", ((null == (e = E$4()) ? void 0 : e.menuColorSetting) || { adaptableColorSchemes: ["light"] }).adaptableColorSchemes.join(" "));
...
function Ee(t) {
	var r = E$4(), n = (null == r ? void 0 : r.menuColorSetting) || {
		adaptableColorSchemes: ["light"],
		lightModeColor: Le,
		darkModeColor: Ae
	}, o = n.adaptableColorSchemes, i = n.lightModeColor, a = n.darkModeColor, c = o.includes("dark");
	t.matches && c ? Ue(__assign(__assign({}, Ae), a)) : Ue(__assign(__assign({}, Le), i));
}
function Ue(e) {
	var t = e.iconColor, r = e.statusBarColor, n = e.titleTextColor, o = e.titleSubtextColor, i = e.titleButtonColor, a = e.titleBackgroundColor, c = e.progressBarColor, s = e.progressBackgroundColor, l = e.titleButtonAreaBackgroundColor, d = e.titleButtonAreaBorderColor, h = e.baseBackgroundColor, p = e.baseTextColor, m = e.lightButtonBorderColor;
	Pe("--liff-base-background-color", h), Pe("--liff-base-text-color", p), Pe("--liff-base-background-rgb-color", h$9(h)), Pe("--liff-base-text-rgb-color", h$9(p)), Pe("--liff-light-button-border-color", m), Pe("--liff-title-text-color", n), Pe("--liff-title-background-color", a), Pe("--liff-title-button-color", i), Pe("--liff-icon-color", t), Pe("--liff-status-bar-color", r), Pe("--liff-title-subtext-color", o), Pe("--liff-progress-bar-color", c), Pe("--liff-progress-background-color", s), Pe("--liff-title-button-area-background-color", l$11(l)), Pe("--liff-title-button-area-border-color", l$11(d));
}
function Pe(e, t) {
...
var Ne = {
	addToHomeScreen: function(e) {
		if (!new o$2(e).invoke("addToHomeScreen")) throw b$7(i$3, "No permission for liff.addToHomeScreen()");
	},
	scanCode: function(e) {
		if (!new o$2(e).invoke("scanCode")) return Promise.reject(b$7(i$3, "No permission for liff.scanCode()"));
	},
	getAdvertisingId: function(e) {
		if (!new o$2(e).invoke("getAdvertisingId")) return Promise.reject(b$7(i$3, "No permission for liff.getAdvertisingId()"));
	},
	...
	return __awaiter(this, void 0, void 0, function() {
		...
		return __generator(this, function(r) {
			switch (r.label) {
				...
				case 1: return (t = r.sent()) ? (t.install(e, Ne), [3, 3]) : [2];
				case 2: return n = r.sent(), i$5.warn("[LIFF Init] failed to load legacy extensions, related APIs will be unavailable", n), [3, 3];
				case 3: return [2];
			}
		});
	});
...
function We(e) {
	var t = e.pathname, r = e.query, n = r ? "?".concat(L$4.stringify(r)) : "", o = "".concat("liff://").concat(t).concat(n);
	location.href = o;
}
var Me = null;
function Re() {
	"boolean" == typeof Me && i$5.warn("liff.init is not expected to be called more than once"), Me = !!O$3() || !(!u$10() || L$4.parse(window.location.hash).feature_token || w$7()) && (P$1(!0), !0);
}
function je() {
	return Boolean(Me);
}
function He(e, n) {
	return __awaiter(this, void 0, void 0, function() {
		...
		return __generator(this, function(r) {
			switch (r.label) {
				case 0: return (t = D$2()) ? [2, t] : e && n ? [4, Ae$1({
					msit: e,
					mstVerifier: n
				})] : [3, 2];
...
function Ve(e) {
	return f$9("".concat(l$7("apps"), "/").concat(e, "/featureToken"));
}
function qe(e) {
	return __awaiter(this, void 0, void 0, function() {
		var t, o, i, a;
		return __generator(this, function(r) {
			switch (r.label) {
				case 0: return t = L$4.parse(window.location.hash), o = function(e) {
...
function Je(e) {
	if (e.persisted && T$1("multipleLiffTransition")) if ("ios" === e$4()) window.location.reload();
	else {
		var t = c$7().liffId, r = w$7();
		if (!t) throw b$7(I$5, "Invalid LIFF ID.");
		if (!r) throw b$7(i$3, "Invalid featureToken for client features");
		We({
...
function ze(e) {
	return __awaiter(this, void 0, void 0, function() {
		var t, n, o, i, a, c, s, f, u, p, w, g, k, F, C, y, I, B, _;
		return __generator(this, function(r) {
			switch (r.label) {
				case 0: return [4, new Promise(function(e) {
					var t = r$4();
					if (!t || p$10(t, "9.5.0") < 0) e();
					else if (window._liff && window._liff.features) e();
					else {
						i$5.debug("cannot find window._liff.features, listen to ready event");
						var r = function() {
							i$5.debug("ready event is fired"), u$6("ready", r), e();
						};
						s$5("ready", r);
					}
				})];
				case 1: return r.sent(), Re(), [4, qe(e.liffId)];
				case 2:
					if (t = r.sent(), n = t.access_token, o = t.context_token, i = t.feature_token, a = t.id_token, c = t.client_id, s = t.mst_verifier, f = t.mst_challenge, u = t.msit, o) {
						if ("string" != typeof o) throw b$7(I$5, "Cannot get context token, perhaps there is an incorrect parameter in permanent link");
						I$3(De(o));
					}
					if (void 0 !== (null === (B = E$4()) || void 0 === B ? void 0 : B.liffId) && (null === (_ = E$4()) || void 0 === _ ? void 0 : _.liffId) !== e.liffId) throw b$7(I$5, "Invalid LIFF ID");
					return !d$7() && i && (function(e, t) {
						T$1("multipleLiffTransition") && We({
							pathname: "app/".concat(e),
							query: { feature_token: t }
						});
					}(e.liffId, i), je() && U$3(i)), f && R$3(f), s && A$1(s), c && F$3(c), u && C$4(u), window.addEventListener("pageshow", Je), e$7() ? [3, 5] : i && n ? [3, 5] : je() ? (p = P$2(location.href, { "liff.hback": "2" }), v$4({ redirectUri: p }), [4, new Promise(function() {})]) : [3, 4];
				case 3: r.sent(), r.label = 4;
				case 4: throw v$4(), b$7(I$5, "Failed to parse feature_token or access_token");
				case 5: return n && i ? [4, d$5(n)] : [3, 7];
				case 6:
					if (w = r.sent(), g = w.client_id, k = w.expires_in, F = R$4(e.liffId), g !== F) throw v$4(), b$7(I$5, "Failed to verify access_token");
					U$3(i), q$2(new Date(Date.now() + 1e3 * k)), B$1(n), r.label = 7;
				case 7: return [4, He(u, s)];
				case 8: return (C = r.sent()) ? (L$3(C), [4, Je$1({ mst: C })]) : [3, 10];
				case 9: (y = r.sent().data) && N$2(JSON.stringify(y)), r.label = 10;
				case 10: return a && !X$1() && G$1(a), a && c && !Z$1() ? [4, y$2(a, c)] : [3, 12];
				case 11: (I = r.sent()) && $$1(I), r.label = 12;
				case 12: return [2];
			}
		});
	});
...
function Ke(e) {
	return __awaiter(this, void 0, void 0, function() {
		...
		return __generator(this, function(r) {
			switch (r.label) {
				case 0: return t = l$7("apps"), n = "".concat(t, "/").concat(e, "/contextToken"), o = x$3(), i = {
					"Content-Type": "application/json",
					Accept: "application/json"
				}, o && (i.Authorization = "Bearer ".concat(o)), [4, f$9(n, { headers: i })];
				case 1:
					if (a = r.sent(), !(c = a.contextToken)) throw b$7(I$5, "Can not get context from server.");
					if (!(s = De(c))) throw b$7(I$5, "Invalid context token.");
					return [2, s];
			}
		});
	});
...
function Ge() {
	return __awaiter(this, void 0, void 0, function() {
		...
		return __generator(this, function(r) {
			switch (r.label) {
				case 0:
					if (!(e = c$7().liffId)) throw b$7(I$5, "Invalid LIFF ID.");
					return [4, Ke(e)];
				case 1: return t = r.sent(), I$3(t), [2];
			}
		});
	});
}
			...
			switch (c.label) {
				case 0: n = function() {
					return __awaiter(a, void 0, void 0, function() {
						...
						return __generator(this, function(r) {
							switch (r.label) {
								case 0: return [4, (s = c$7(), l = L$4.parse(window.location.search), f = J(), u = {
								...
								}, d = L$4.stringify(u), f$9(l$7("token"), {
									method: "POST",
									headers: { "Content-Type": "application/x-www-form-urlencoded;charset=UTF-8" },
									body: d
								}))];
								case 1: return t = r.sent(), n = t.access_token, o = t.id_token, i = t.expires_in, F$3(e), B$1(n), q$2(new Date(Date.now() + 1e3 * i)), W(), o ? (G$1(o), [4, y$2(o, e)]) : [3, 3];
								case 2: (a = r.sent()) && $$1(a), r.label = 3;
								case 3: return (c = L$4.parse(location.hash).context_token) ? (I$3(De(c)), [3, 6]) : [3, 4];
								case 4: return [4, Ge()];
				...
				case 2: return c.sent(), [3, 4];
				case 3: throw o = c.sent(), i = o, W(), i;
				case 4: return [2];
			}
		});
	});
...
function Xe() {
	return __awaiter(this, void 0, void 0, function() {
		...
		return __generator(this, function(f) {
			switch (f.label) {
				case 0: return (n = ae()) ? [3, 2] : [4, ue(h$5.SUB)];
				case 1: n = f.sent(), f.label = 2;
				case 2: return (e = n).isReady() ? (o = E$5(8), [4, e.getData("appData")]) : [3, 8];
				case 3: return i = f.sent(), a = i.eventName, c = i.data, a !== l$6.NOT_FOUND ? [3, 6] : [4, e.teardown()];
				case 4: return f.sent(), [4, Xe()];
				case 5: return [2, f.sent()];
				case 6: c && N$2(JSON.stringify(c)), f.label = 7;
				case 7: return e.listen(function(n) {
					return __awaiter(s, void 0, void 0, function() {
						var t, i;
						return __generator(this, function(r) {
							return t = n.context, i = t.data, t.eventName === L$5.INIT && (null == i ? void 0 : i.subWindowId) !== o && r$1(), t.eventName !== L$5.CANCEL && t.eventName !== L$5.SUBMIT || e.teardown(), [2];
						});
					});
				}), e$7() && e.send({
					eventName: L$5.INIT,
					...
					window.addEventListener("message", function(e) {
						return function t(r) {
							...
							if (n) {
								...
								a === "healthCheck" && (window.removeEventListener("message", t), c && N$2(c), de(i), o && o.postMessage && o.postMessage({ status: "healthCheck" }, i), e());
							}
						};
					}(e));
				})];
...
var Ye = new (function() {
	function e() {
		...
		this.getAndValidateContext = function() {
			var e = E$4();
			if (!e) throw b$7(I$5, "Could not get Context from server.");
			if (!e.endpointUrl) throw b$7(I$5, "Could not get endpointUrl from server.");
			if (!e.permanentLinkPattern) throw b$7(I$5, "Could not get permanentLinkPattern from server.");
			return e;
	...
	return e.prototype.attachSlashAtStart = function(e) {
		...
		return __awaiter(this, void 0, void 0, function() {
			...
			return __generator(this, function(r) {
				switch (r.label) {
					case 0:
						if (e = L$4.parse(window.location.search), "string" != typeof (t = e["liff.state"])) return [2];
						r.label = 1;
					case 1: return r.trys.push([
						...
						,
						5
					]), n = location.href, (o = this.decodeState(t)) === n ? [3, 3] : (e["liff.hback"] ? location.replace(P$2(o, { "liff.hback": e["liff.hback"] })) : location.replace(o), [4, new Promise(function() {})]);
					case 2: r.sent(), r.label = 3;
					case 3: return [3, 5];
					case 4:
						if ((i = r.sent()).code === "INIT_FAILED") throw i;
						return i$5.debug(i), [3, 5];
					case 5: return [2];
				}
			});
		});
...
function Ze(e, n) {
	return __awaiter(this, void 0, void 0, function() {
		...
		return __generator(this, function(r) {
			switch (r.label) {
				case 0:
					if (!e.liffId) throw b$7(T$4, "liffId is necessary for liff.init()");
					return l$10(e), !u$10() && e$7() && (z$2() || o$1()), t = L$4.parse(window.location.search), !d$7() || u$10() ? [3, 2] : [4, Xe()];
				case 1: r.sent(), r.label = 2;
				case 2:
					if (t.error && t.liffOAuth2Error) throw c = t.error, s = t.error_description, f = s.replace(/\+/g, " "), u = "".concat(c, ": ").concat(f), b$7(I$5, u);
					return i = t.code, a = J(), Boolean(i && !e$7() && a && a.codeVerifier) ? [4, Qe(t.liffClientId)] : [3, 4];
				case 3: r.sent(), r.label = 4;
				case 4: return u$10() ? [4, ze(e)] : [3, 6];
				case 5: return r.sent(), [3, 8];
				case 6: return e$7() ? [3, 8] : [4, Ge()];
				case 7: r.sent(), r.label = 8;
				case 8: return [4, Ye.invoke()];
				case 9:
					if (r.sent(), o = E$4()) try {
						b$4(location.href, o.endpointUrl);
					} catch (h) {
						i$5.warn("liff.init() was called with a current URL that is not related to the endpoint URL.\n".concat(location.href, " is not under ").concat(o.endpointUrl));
					}
					return [4, n()];
				case 10: return r.sent(), k$2(window.location.href), [2];
			}
			var i, a, c, s, f, u;
		});
	});
	...
	return __awaiter(void 0, void 0, void 0, function() {
		...
		return __generator(this, function(t) {
			switch (t.label) {
				...
				case 3: return t.sent(), [4, (r = E$5(6), new Promise(function() {
					var e = document.createElement("div");
					e.innerHTML = "<lui-alert id=\"".concat(tt, "-").concat(r, "\" shown title=\"").concat(g$3("alert.android.extBrowser.autoLoginWorkaround.title"), "\" message=\"").concat(g$3("alert.android.extBrowser.autoLoginWorkaround.desc"), "\" button=\"").concat(g$3("alert.android.extBrowser.autoLoginWorkaround.button.text"), "\"></lui-alert>"), document.body.appendChild(e);
					var t = document.getElementById("".concat(tt, "-").concat(r));
					t && t.addEventListener("lui-button-click", function() {
						var e = window.open(P$2(window.location.href, { liffIsEscapedFromApp: "true" }), "_blank");
						e && (e.location.href = P$2(window.location.href, { liffIsEscapedFromApp: "true" }), window.close());
					});
				}))];
...
function ot() {
	return __awaiter(this, void 0, void 0, function() {
		...
		return __generator(this, function(r) {
			switch (r.label) {
				case 0: return e = null !== (n = nt(window.location.href)) && void 0 !== n ? n : nt(window.document.referrer), !!e && p$10(e, "13.10.0") >= 0 ? [2] : u$10() || "android" !== e$4() || (t = L$4.parse(window.location.search))["liff.subwindow.identifier"] || t.liffIsEscapedFromApp ? [2] : t.liffClientId && document.referrer.includes("access.".concat("line.me")) ? (window.location.href = P$2(window.location.href, { liffIsEscapedFromApp: "true" }), [2]) : t.liffClientId && document.referrer.includes("android-app://") ? [4, rt()] : [3, 2];
				case 1: r.sent(), r.label = 2;
...
var it = function(e) {
	function n() {
		...
		return t.hooks = {
			...
			beforeFinished: new a$2(),
			beforeSuccess: new a$2(),
			error: new a$2()
		}, t;
	}
		...
		return __awaiter(this, void 0, void 0, function() {
			...
			return __generator(this, function(r) {
				switch (r.label) {
					...
					case 3: return r.sent(), Te(), [4, this.internalHooks.beforeSuccess.call()];
					case 4: return r.sent(), !e.withLoginOnExternalBrowser || e$7() ? [3, 6] : (v$4(), [4, new Promise(function() {})]);
					case 5: r.sent(), r.label = 6;
					case 6: return [4, ot()];
					case 7: return r.sent(), [4, this.hooks.after.call()];
					case 8: return r.sent(), "function" == typeof n && n(), e$9(), [3, 11];
...
function f$4() {
	var r = r$4();
	if (!r || !u$10() || "ios" !== e$4()) return navigator.language;
	if (p$10(r, "14.11.0") >= 0) {
...
function S$2(r) {
	return __awaiter(this, void 0, void 0, function() {
		var e, i, o, u, l, h, v;
		return __generator(this, function(t$4) {
			switch (t$4.label) {
				case 0: return function(e) {
					if (!k$3.includes(e)) throw b$7("INVALID_ARGUMENT", "Unexpected permission name.");
					var t = E$4();
					return !!(null == t ? void 0 : t.scope.includes(e));
				}(r) ? (e = x$3()) ? [4, d$5(e)] : [3, 2] : [2, { state: "unavailable" }];
				case 1:
					i = t$4.sent(), o = unescape(i.scope).split(" ");
					try {
				...
				case 2: throw b$7(t, "Need access_token for api call, Please login first");
			}
		});
	});
}
function _() {
	var e, t, n = E$4();
	return !!n && "square_chat" !== n.type && (T$1("skipChannelVerificationScreen") || !u$10() && (null === (t = null === (e = n.availability) || void 0 === e ? void 0 : e.skipChannelVerificationScreen) || void 0 === t ? void 0 : t.permission));
}
function q() {
	var e = c$7().liffId;
	if (e) return f$9("".concat(l$7("unauthorizedPermissions"), "?liffId=").concat(e), { headers: {
		"Content-Type": "application/json",
		Accept: "application/json",
		Authorization: "Bearer ".concat(x$3())
	} });
	throw b$7(t, "liffId is required");
}
var x$1;
var E$2 = Re$1.on;
var R$2 = Re$1.off;
...
var z = function() {
			...
			return __awaiter(i, [n], void 0, function(e) {
				...
				return __generator(this, function(e) {
					return n ? this.resolve({
						newAccessToken: n,
						newIdToken: r
					}) : i && this.reject(b$7("UNKNOWN", i)), this.teardown(), [2];
				});
			});
		}, this.onClose = function() {
			return __awaiter(i, void 0, void 0, function() {
				return __generator(this, function(e) {
					return this.reject(b$7(t, "user didn't allow the agreement")), this.teardown(), [2];
				});
			});
	...
	return n.prototype.setup = function() {
		E$2("submit", this.onSubmit), E$2("close", this.onClose), E$2("cancel", this.onCancel), E$2("error", this.onError);
	}, n.prototype.teardown = function() {
		R$2("submit", this.onSubmit), R$2("close", this.onClose), R$2("cancel", this.onCancel), R$2("error", this.onError), x$1 = void 0;
		...
		}).catch(this.reject) : this.reject(b$7(t, "liffId is required"));
	}, n;
}();
function B() {
	return __awaiter(this, void 0, void 0, function() {
		...
		return __generator(this, function(l) {
			switch (l.label) {
				case 0:
					if (!_()) throw b$7(i$3, "SkipChannelVerificationScreen is unavailable.");
					return x$1 && x$1.teardown(), n = function() {
						return __awaiter(a, void 0, void 0, function() {
							var e;
							return __generator(this, function(t) {
								switch (t.label) {
									case 0: return [4, q()];
									case 1:
										if (e = t.sent(), (u$10() ? e : e.filter(function(e) {
											return "chat_message.write" !== e;
										})).length <= 0) throw b$7(i$3, "All permissions have already been approved.");
										return [2];
								}
							});
						});
					}, [4, new Promise(function(e, t) {
						(x$1 = new z(e, t)).open(n);
					})];
				case 1: return r = l.sent(), i = r.newAccessToken, o = r.newIdToken, B$1(i), o ? (s = j$1()) ? [4, y$2(o, s)] : [3, 3] : [3, 3];
...
function F() {
	return __awaiter(this, void 0, void 0, function() {
		...
		return __generator(this, function(t$6) {
			switch (t$6.label) {
				case 0:
					if (!(e = x$3())) throw b$7(t, "Need access_token for api call, Please login first");
					return [4, d$5(e)];
				case 1: return n = t$6.sent(), [2, decodeURIComponent(n.scope).split(" ").filter(function(e) {
					return "" !== e;
				})];
			}
		});
...
function N$1(n, o) {
	...
	return function() {
		...
		return __awaiter(s, void 0, void 0, function() {
			...
			return __generator(this, function(t) {
				switch (t.label) {
					case 0: return e = (c.length > 0 ? c[c.length - 1] : {}).ignorePermissionCheck, s = void 0 !== e && e, [4, S$2(o)];
					case 1:
						if ("unavailable" !== (a = t.sent().state)) return [3, 2];
						throw b$7(i$3, "The permission is not in LIFF app scope.");
					case 2: return "prompt" !== a || !_() || s || !u$10() && "chat_message.write" === o ? [3, 4] : [4, B()];
...
(function(t) {
	...
	return __extends(e, t), Object.defineProperty(e.prototype, "name", {
		...
		return N$1(n$1, "profile");
	}, e;
})(a$7);
//#endregion
//#region node_modules/@liff/open-window/lib/index.es.js
var a$1 = "is_liff_external_open_window";
var p$2 = function(n, i) {
	return n ? "&".concat(n.split("&").filter(function(n) {
		return -1 === n.indexOf(a$1);
...
function s$3(n) {
	...
	}(n)) throw b$7(E$6, "Invalid parameters for liff.openWindow()");
	var u = r$4();
	if (u$10()) if (null !== u && "ios" === e$4() && p$10(u, "9.19") >= 0 || !window._liff.postMessage) {
		var s = n.url, d = n.external, m = void 0 !== d && d;
		window.open(function(n, t) {
			...
			var m = p$2(d, s);
			return "".concat(u, "?").concat(a$1, "=").concat(!!t).concat(m);
		}(s, m));
	} else w$3("openWindow", n);
...
function p$1(r) {
	return Promise.reject(b$7(E$6, r));
}
function l$2(r) {
	if (!function(r) {
		return Array.isArray(r) && r.every(m$3);
	}(r)) return p$1("Parameter 'messages' must be an array of { type, ... }");
	var e = r.length;
	return e < 1 || e > 5 ? p$1("Number of messages should be in range 1 to ".concat(5, ".")) : f$9(l$7("message"), {
		method: "POST",
...
var c$3 = function(r) {
	if ("403" === r.code) {
		var e = "12.0.0" === r$4(), o = "ios" === e$4(), n = J$1();
...
(function(e) {
	...
	return __extends(t, e), Object.defineProperty(t.prototype, "name", {
		...
		return N$1(l$2, "chat_message.write");
	}, t;
})(a$7);
//#endregion
//#region node_modules/@liff/get-friendship/lib/index.es.js
function o() {
	return f$9(l$7("friendship"));
}
(function(t) {
	function e() {
		return null !== t && t.apply(this, arguments) || this;
		...
		return __generator(this, function(e) {
			switch (e.label) {
				...
				case 3:
					...
					e.label = 4;
				case 4: return [3, 6];
				case 5: return e.sent(), i$5.debug("can't retrieve Mid/Uid because of something wrong"), [3, 6];
				case 6: return [2];
			}
		});
	});
	...
	return __extends(p, c), Object.defineProperty(p, "CUSTOMPLACEID_INIT", {
		...
		return new Proxy(t, { get: function(t, e) {
			...
			return "function" == typeof i ? function() {
				...
				return i$5.warn("[LIFF Analytics] ".concat("LIFF Analytics is deprecated and will be removed in a future version. Please migrate to alternative analytics solutions.", " Called method: ").concat(String(e))), i.apply(t, n);
			} : i;
		} });
		...
		this.assignUtsExtra({ version: t }), i$5.debug("[LIFFUTS][SDK version] ".concat(t)), this.setExtra();
	}, p.prototype.setLiffId = function(t) {
		this.assignUtsExtra({ id: t }), i$5.debug("[LIFFUTS][LIFFID] ".concat(t)), this.setExtra();
	}, p.prototype.setIsLoggedIn = function(t) {
		this.assignUtsExtra({ isLoggedIn: t }), i$5.debug("[LIFFUTS][isLoggedIn] ".concat(t)), this.setExtra();
	}, p.prototype.sendLiffInit = function() {
		var t;
		i$5.debug("[LIFFUTS][sendCustom] liff.init"), null === (t = this.uts) || void 0 === t || t.sendCustom({
			type: p.CUSTOMTYPE,
			params: { placeId: p.CUSTOMPLACEID_INIT }
		});
	}, p.prototype.setIsLiffSuccessful = function(t) {
		this.assignUtsExtra({ isLiffSuccessful: t }), i$5.debug("[LIFFUTS][isLiffInitSuccessful] ".concat(t)), this.setExtra();
		...
		return __awaiter(this, void 0, void 0, function() {
			var t, i, n, r, o, c, p, m, I, L, v, y;
			return __generator(this, function(e) {
				switch (e.label) {
					case 0:
						if (t = L$4.parse(window.location.search), this.prepareReferrer(t), i = E$4(), !(n = null == i ? void 0 : i.utsTracking)) return [2];
						if (r = c$7(), o = r.liffId, c = r.analytics, "auto" !== n.mode || !c) return [3, 6];
						i$5.warn("[LIFF Analytics] LIFF Analytics is deprecated and will be removed in a future version. Please migrate to alternative analytics solutions."), i$5.debug("[LIFFUTS] ".concat((/* @__PURE__ */ new Date()).toUTCString())), e.label = 1;
					case 1: return e.trys.push([
						1,
						3,
						,
					...
					case 3: return m = e.sent(), i$5.debug("[LIFFUTS] cannot load UTS, reason: ".concat(m)), [2];
					case 4: return I = __assign(__assign({}, c.context), {
						...
						version: "current"
					}), this.uts.init(I, L), [4, b$1()];
					case 5: (v = e.sent()) && (i$5.debug("[LIFFUTS][mid] ".concat(v)), this.uts.setMid(v)), null != i && i.tid && (i$5.debug("[LIFFUTS][tid] ".concat(i.tid)), this.uts.setTid(i.tid)), this.referrer && (i$5.debug("liff.ref.referrer", this.referrer), this.uts.setSessionParams(this.referrer)), o && this.setLiffId(o), this.setIsLoggedIn(e$7()), this.setVersion(r$5()), y = j$2(location.href), i$5.debug("[LIFFUTS][url] ".concat(y)), this.uts.setUrl(y), this.liffCore.analytics = this.createDeprecatedUtsProxy(this.uts), this.injected = !0, e.label = 6;
					case 6: return [2];
				}
			});
		});
...
var v$3 = function(t) {
	i$5.warn("[LIFF Analytics] LIFF Analytics is deprecated and will be removed in a future version. Please migrate to alternative analytics solutions. Called function: sendShareTargetPicker"), i$5.debug("[LIFFUTS][sendCustom] liff.shareTargetPicker"), t.sendCustom({
		type: "liffSdk",
...
var u$2 = function() {
	...
	return o.prototype.start = function() {
		Re$1.on("submit", this.onSubmit), Re$1.on("close", this.onClose), Re$1.on("cancel", this.onCancel), Re$1.on("error", this.onError);
	}, o.prototype.destroy = function() {
		Re$1.off("submit", this.onSubmit), Re$1.off("close", this.onClose), Re$1.off("cancel", this.onCancel), Re$1.off("error", this.onError), s$2 = void 0;
	}, o;
}();
function f$1() {
	return __awaiter(this, void 0, void 0, function() {
		return __generator(this, function(o) {
			return k.scanCodeV2(), s$2 && s$2.destroy(), [2, new Promise(function(o, t) {
				s$2 = new u$2(o, t), Re$1.open({ url: "https://liff.line.me/1656359117-jxmx5e11" }).catch(function(o) {
					s$2?.destroy(), t(o);
				});
			})];
		});
...
function u$1(t, o, n, i) {
	if (void 0 === n && (n = {}), "object" != typeof t || !t.postMessage) throw b$7(E$6, "target must be window object");
	if ("string" != typeof o) throw b$7(E$6, "keyname must be string");
	if ("object" != typeof n) throw b$7(E$6, "incorrect body format. It should be Object or Array comprised of Object");
	if (!i) throw b$7(E$6, "serverEndPointUrl isn't passed. please fill up with proper url");
...
function m$2(t, e, r, n) {
	c$1(t, "message.".concat(e), function(t, e, r) {
		return function(n) {
			i$5.debug("messageReceive", n), n.origin === r && n.data.name === t && e(n);
		};
	}(e, r, n));
}
//#endregion
...
var R$1 = function() {
	...
	return i.getInstance = function() {
		...
		var t, e;
		this.abortController && this.abortController.abort(), u$10() || (t = this.timeoutIDForHealthCheck, e = this.popupWindow, s$1(window, "message.receivedHealthcheck"), t && clearTimeout(t), e && !e.closed && e.close());
		...
		return void 0 === t && (t = l$7("shareTargetPicker")), W$1(t);
	}, i.prototype.initOtt = function() {
		return __awaiter(this, void 0, void 0, function() {
			var t, i, r;
			return __generator(this, function(e) {
				switch (e.label) {
					case 0: return this.abortController && (t = this.abortController.signal), i = "".concat(l$7("shareTargetPickerOtt"), "/").concat(this.liffId, "/ott"), r = this, [4, f$9(i, {
						method: "GET",
						signal: t
					}).then(function(t) {
						return t.ott;
		...
		u$10() || ("ios" !== e$4() || J$1() ? this.popupWindow = window.open("", "liffpopup", "width=480, height=640, menubar=no, toolbar=no, scrollbars=yes") : this.popupWindow = window.open());
	}, i.prototype.openAnotherWindow = function() {
		if (u$10() && this.payloadToShareTargetPicker) t = this.liffId, e = this.ott, i = this.payloadToShareTargetPicker, r = {
			liffId: t,
			ott: e,
			data: JSON.stringify(i),
			closeModals: !1
		}, location.href = "".concat("line://picker", "?").concat(L$4.stringify(r));
		else {
			if (this.timeoutIDForHealthCheck = window.setTimeout(this.healthCheck.bind(this), 1e3), !this.popupWindow) throw b$7(l$12);
			(function(t, e, i) {
				var r = {
					liffId: e,
					ott: i
				};
				t.location.href = "".concat(l$7("shareTargetPicker"), "?").concat(L$4.stringify(r));
			})(this.popupWindow, this.liffId, this.ott);
		}
		var t, e, i, r;
	}, i.prototype.initListener = function() {
		var t, e;
		u$10() || (t = this.onReceivedHealthcheck.bind(this), e = this.allowPostMessageOrigin, m$2(window, "receivedHealthcheck", t, e));
		...
		return __awaiter(this, void 0, void 0, function() {
			...
			return __generator(this, function(e) {
				switch (e.label) {
					...
					case 6: return [3, 8];
					case 7: i = this.popupWindow, r = this.allowPostMessageOrigin, u$1(i, "healthcheck", void 0, r), this.timeoutIDForHealthCheck = window.setTimeout(this.healthCheck.bind(this), 1e3), e.label = 8;
					case 8: return [2];
				}
				var i, r;
			});
		...
		if (!this.popupWindow || !this.payloadToShareTargetPicker) throw b$7(l$12);
		...
		return __awaiter(this, void 0, void 0, function() {
			...
			return __generator(this, function(e) {
				switch (e.label) {
					case 0:
						if (u$10() || !this.ott) throw new Error("need to call with ott in client");
						return this.abortController && (t = this.abortController.signal), i = {
							liffId: this.liffId,
							ott: this.ott
						}, [4, f$9("".concat(l$7("shareTargetPickerResult"), "?").concat(L$4.stringify(i)), {
							method: "POST",
							signal: t,
							headers: {
								Accept: "application/json",
		...
		return __awaiter(this, void 0, void 0, function() {
			...
			return __generator(this, function(e) {
				...
				return this.abortController && (t = this.abortController.signal), i = {
					liffId: this.liffId,
					ott: this.ott
				}, i$5.debug("fetch: getShareResult"), [2, f$9("".concat(l$7("shareTargetPickerResult"), "?").concat(L$4.stringify(i)), {
					method: "GET",
					headers: { Accept: "application/json" },
					signal: t
				})];
		...
		return i.shareTargetPicker = function(n) {
			...
			return __awaiter(i, __spreadArray([n], __read(c), !1), void 0, function(t, i) {
				...
				return void 0 === i && (i = {}), __generator(this, function(e) {
					switch (e.label) {
						case 0:
							if (k.shareTargetPicker(), !t || !Array.isArray(t) || 0 === t.length) throw b$7(E$6, "no proper argument");
							if (t.length > 5) throw b$7(E$6, "exceed the limit of num of messages");
							if (!(r = c$7().liffId)) throw b$7(T$4);
							window.liff && (o = window.liff).analytics && v$3(o.analytics), n = void 0 === i.isMultiple || i.isMultiple, e.label = 1;
						case 1: return e.trys.push([
							1,
							3,
							,
							4
						]), c = R$1.getInstance(), u = r$4(), f = { waitForSubwindowResult: !0 }, u$10() && u && p$10(u, "10.11.0") < 0 && (f.waitForSubwindowResult = !1), [4, c.init({
							messages: t,
							isMultiple: n,
							referrer: {
								liffId: r,
						...
						case 3: throw (v = e.sent()) instanceof y$8 ? v : b$7(o$4, v.message);
						case 4: return [2];
					}
				});
			});
...
function S$1(n, e) {
	return __awaiter(this, void 0, void 0, function() {
		...
		return __generator(this, function(r) {
			switch (r.label) {
				case 0: return t = l$7("createShortcutOnHomeScreen"), (i = new URL(t)).searchParams.append("liffId", n), i.searchParams.append("url", e.url), e.description && i.searchParams.append("description", e.description), [4, f$9(i.toString())];
...
function g$1(t) {
	if (B$2(t)) throw b$7(E$6, "LINE URL scheme are not supported in the current environment.");
}
function I(n, e) {
	return __awaiter(this, void 0, void 0, function() {
		var t;
		return __generator(this, function(r) {
			switch (r.label) {
				case 0: return u$10() ? [2] : [4, new Promise(function(t) {
					setTimeout(t, 1e3);
				})];
				case 1: return r.sent(), "hidden" === document.visibilityState ? [2] : (g$1(e.url), [4, S$1(n, e)]);
				case 2: return t = r.sent(), s$3({
					url: t,
					external: !0
				}), [2];
			}
	...
	return __awaiter(this, void 0, void 0, function() {
		...
		return __generator(this, function(r) {
			switch (r.label) {
				...
				}, i = "".concat("line://shortcut/liff", "?").concat(L$4.stringify(t)), location.href = i, [4, I(n, e)];
...
function P(n, e) {
	return __awaiter(this, void 0, void 0, function() {
		...
		return __generator(this, function(r) {
			switch (r.label) {
				case 0: return g$1(e.url), [4, S$1(n, e)];
				case 1: return t = r.sent(), s$3({
					url: t,
					external: !0
				}), [2];
			}
...
function H(t) {
	var r;
	if (void 0 === t.url || null === t.url || "" === t.url) throw b$7(E$6, "no proper argument");
	var n = E$4();
	if (!(null === (r = null == n ? void 0 : n.availability.addToHomeLineScheme) || void 0 === r ? void 0 : r.permission)) {
		if (B$2(t.url)) throw b$7(i$3, "No permission to specify line schema in url.");
		if (t.description) throw b$7(i$3, "No permission to specify description.");
	}
	if (!B$2(t.url)) {
		if (!n) throw b$7(i$3, "Could not get Context from server.");
		n.liffId !== F$4(t.url) && b$4(t.url, n.endpointUrl);
	}
}
function L(n) {
	return __awaiter(this, void 0, void 0, function() {
...
function x(n) {
	return __awaiter(this, void 0, void 0, function() {
		...
		return __generator(this, function(r) {
			switch (r.label) {
				case 0:
					if (!(t = c$7().liffId)) throw b$7(I$5, "Invalid LIFF ID.");
					return "ios" === e$4() ? [4, P(t, n)] : [3, 2];
...
function l(e) {
	return __awaiter(this, arguments, void 0, function(t) {
		...
		return __generator(this, function(t) {
			switch (t.label) {
				case 0: return [4, w$3("iap.getPlatformProducts", { productIds: e }).catch(function(t) {
					if (t.code && t.description) throw b$7(t.code, t.description);
					throw b$7(e$8, "Failed to get platform products", { cause: t });
				})];
...
var h$1 = function(e) {
	return __awaiter(void 0, [e], void 0, function(t) {
		...
		return __generator(this, function(t) {
			switch (t.label) {
				case 0:
					if (!window.confirm("Proceed with a test in-app purchase?")) throw b$7("CANCELED", "Transaction was canceled.");
					return [4, f$9(l$7("iapVirtualConfirm"), {
						method: "POST",
						body: JSON.stringify({
							productId: e,
							orderId: o
...
var m$1 = function(e) {
	return __awaiter(void 0, [e], void 0, function(t) {
		...
		return __generator(this, function(t) {
			switch (t.label) {
				case 0: return (null == (e = E$4()) ? void 0 : e.isIapSandbox) ? [4, h$1({
					productId: o,
					orderId: n
				})] : [3, 2];
				case 1:
				case 3: return t.sent(), [2];
				case 2: return [4, w$3("iap.createPayment", {
					productId: o,
					orderId: n
				}).catch(function(t) {
					if (t.code && t.description) throw b$7(t.code, t.description);
	...
	return __extends(s, i), Object.defineProperty(s.prototype, "name", {
		...
		return {
			...
			createPayment: function() {
				...
				return __awaiter(e, void 0, void 0, function() {
					return __generator(this, function(t) {
						return k.iap(), [2, m$1.apply(void 0, __spreadArray([], __read(i), !1))];
					});
				});
			},
				...
				return __awaiter(e, void 0, void 0, function() {
					return __generator(this, function(e) {
						return k.iap(), [2, __awaiter(void 0, void 0, void 0, function() {
							return __generator(this, function(t) {
								switch (t.label) {
									case 0: return [4, w$3("iap.requestConsentAgreement").catch(function(t) {
										if (t.code && t.description) throw b$7(t.code, t.description);
										throw b$7(e$8, "Failed to request consent agreement", { cause: t });
									})];
									case 1: return t.sent(), [2];
								}
							});
...
var E = function() {
	function t$3(t$2, r) {
		...
		this.onSubmit = function(t) {
			return __awaiter(s, void 0, void 0, function() {
				return __generator(this, function(e) {
					return t.ADD_FRIEND_ERROR ? this.reject(b$7(o$4, t.ADD_FRIEND_ERROR_MESSAGE || t.ADD_FRIEND_ERROR)) : this.resolve(), this.teardown(), [2];
				});
			});
		}, this.onClose = function() {
			return __awaiter(s, void 0, void 0, function() {
			...
			return __awaiter(s, void 0, void 0, function() {
				return __generator(this, function(t$1) {
					return this.reject(b$7(t, "user didn't complete the friend request")), this.teardown(), [2];
				});
			});
	...
	return t$3.prototype.setup = function() {
		...
		b("submit", this.onSubmit), b("close", this.onClose), b("cancel", this.onCancel), b("error", this.onError), v$1 = void 0;
		...
		}).catch(this.reject) : this.reject(b$7(T$4, "liffId is required"));
	}, t$3;
}();
function D() {
	return __awaiter(this, void 0, void 0, function() {
		...
		return __generator(this, function(i) {
			switch (i.label) {
				case 0: t = c$7().liffId, i.label = 1;
				case 1: return i.trys.push([
					1,
					3,
					,
					4
				]), [4, p$6("".concat(l$7("oaAddFriendRateLimit"), "?liffId=").concat(t), { method: "POST" })];
				case 2: return e = i.sent(), [3, 4];
				case 3: throw i.sent(), b$7(e$8, "Failed to check rate limit");
				case 4:
					if (429 === e.status) throw b$7(_$4, "Rate limit exceeded for friend request");
					if (!e.ok) throw b$7(e$8, "Failed to check rate limit");
					return [2];
			}
		});
	});
...
function j() {
	return __awaiter(this, void 0, void 0, function() {
		return __generator(this, function(t) {
			switch (t.label) {
				case 0: return k.requestFriendship(), v$1 && v$1.teardown(), [4, new Promise(function(t, e) {
					(v$1 = new E(t, e)).open(D);
				})];
				case 1: return t.sent(), [2];
			}
		});
...
var u = new I$4();
var c = "activityCallState";
var v = "activityRecordingState";
var d = function(t) {
...
function g() {
	...
	var t = m();
	if (null === t) throw b$7(N$3, "Call state has not been received from the native client yet");
	return t;
}
function y() {
	k.activityGetRecordingState();
	var t = p();
	if (null === t) throw b$7(N$3, "Recording state has not been received from the native client yet");
	return t;
}
var h = new (function(e) {
	...
	return __extends(n, e), Object.defineProperty(n.prototype, "name", {
		...
		return !z$3() && u$10() && (s$5("activityCallStateChange", function(t) {
			var e;
			null !== (e = null == t ? void 0 : t.detail) && void 0 !== e && e.data && d(t.detail.data);
		}), s$5("activityRecordingStateChange", function(t) {
			var e;
...
var liff$1 = Object.defineProperties({}, {
	...
	getProfile: {
		value: N$1(n$1, "profile"),
		enumerable: true,
		writable: true
	},
	sendMessages: {
		value: N$1(l$2, "chat_message.write"),
		enumerable: true,
		writable: true
	},
	subWindow: {
...
var driver = new u$11();
var contextHolder = new s$10(driver, liff$1);
var use = new c$10(driver, contextHolder).install();
function applyModule(module) {
	use.call(liff$1, module);
}
[
	new c$10(driver, contextHolder),
	new w$1(),
	new it(),
	new L$1(),
	c$2,
